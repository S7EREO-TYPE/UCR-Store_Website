...
export default function CartDrawer({ isOpen, onClose, cartItems, onRemoveItem, onNavigateToCheckout }: CartDrawerProps) {
            ...
            {cartItems.length > 0 && (
              <div className="p-8 border-t border-outline-variant/20 bg-surface">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-2xl font-serif italic text-primary">${calculateTotal().toFixed(2)}</span>
                </div>
                <button 
